...
final class TestCrypto extends FunSuite with Matchers {
  ...
  test("Encryption/MAC Interop Checks") {
    encrypt(
      key = "",
      msg = "Hello World",
      macHex = Some("48e8d321ca924207f6854e438437123777f89a50"),
      macBase64 = Some("SOjTIcqSQgf2hU5DhDcSN3f4mlA="),
      macBase64URLSafe = Some("SOjTIcqSQgf2hU5DhDcSN3f4mlA="),
    ...
    encrypt(
      key = "a",
      msg = "Hello World",
      macHex = Some("8f97ebdc103a55aa0f5670c0c79c0cd67403078a"),
      macBase64 = Some("j5fr3BA6VaoPVnDAx5wM1nQDB4o="),
      macBase64URLSafe = Some("j5fr3BA6VaoPVnDAx5wM1nQDB4o="),
    ...
    encrypt(
      key = "abc",
      msg = "Hello World",
      macHex = Some("33fd4e5d116f362d81596809afdc6e17be914614"),
      macBase64 = Some("M/1OXRFvNi2BWWgJr9xuF76RRhQ="),
      macBase64URLSafe = Some("M_1OXRFvNi2BWWgJr9xuF76RRhQ="),
    ...
    encrypt(
      ...
      msg = "Hello World",
      macHex = Some("8e7051b534b01cf18ef034b61a6590aba4bed6d1"),
      macBase64 = Some("jnBRtTSwHPGO8DS2GmWQq6S+1tE="),
      macBase64URLSafe = Some("jnBRtTSwHPGO8DS2GmWQq6S-1tE="),
    ...
    encrypt(
      ...
      msg = "Hello World",
      macHex = Some("6dbaf536c13f4b56b1b8328da43aabe369413343"),
      macBase64 = Some("bbr1NsE/S1axuDKNpDqr42lBM0M="),
      macBase64URLSafe = Some("bbr1NsE_S1axuDKNpDqr42lBM0M="),
    ...
    encrypt(
      ...
      macHex = Some("77096b896c8b7ff50610e50f0771808b3f341a5e"),
      macBase64 = Some("dwlriWyLf/UGEOUPB3GAiz80Gl4="),
      macBase64URLSafe = Some("dwlriWyLf_UGEOUPB3GAiz80Gl4="),
